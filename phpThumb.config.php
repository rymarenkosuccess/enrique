...
$PHPTHUMB_CONFIG['cache_directory'] = dirname(__FILE__).'/assets/cache/';                            // set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['cache_source_directory'] = dirname(__FILE__).'/assets/cache/source/';  // set the cache directory for unprocessed source images
