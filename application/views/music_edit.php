...
<!-- BEGIN SAMPLE FORM PORTLET-->   
              <div class="portlet box blue">
                 ...
                 <div class="portlet-body form">
                    <?php 
                    echo form_open_multipart("content/music_player/edit/".$post['id'], 'class="form-horizontal"');
                                ...
                                <div class="controls">
                                    <div class="row-fluid fileupload-buttonbar">
                                        <div class="span7">
                                            ...
                                            <span>Add files...</span>
                                            <input id='' type="file" id="some-file-input-field" name="music" >
                                            </span>
                                        </div>
                                        ...
                                        <tbody class="files" data-toggle="modal-gallery" data-target="#modal-gallery">
                                            <?php if($post['destination']): ?>
                                                <tr class="template-download fade in">
                                                    <td class="name">
                                                        <a href="<?PHP if(is_file(UPLOAD_DIR.$post['destination'])) echo UPLOAD_URL.$post['destination']; ?>" title="" data-gallery="gallery" download="">music</a>
                                                    </td>
                                                    <td class="size"><span><?php echo $post['format_size']; ?></span></td>
                                                    <td colspan="2"></td>
                                                    <td class="delete">
                                                        <input name="nusic" value="<?php echo $post['destination']; ?>" type="hidden">
                                                        <input type="hidden" name='destination' value='<?php echo $post['destination']; ?>'>
                                                        <input type="hidden" name='music_mime' value='<?php echo $post['music_mime']; ?>'>
                                                        <input type="hidden" name='music_size' value='<?php echo $post['music_size']; ?>'>
